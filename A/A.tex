...
\end{enumerate} 
\textbf{Lemma}\\
Sei $f \in K[x]$ und seien $L_1, L_2$ Zerfällungskörper von $f$. Seien Zeischenkörper $M_i$ mit K $\subset M_i \subset L_i$ gegeben und sei $\sigma: M_1 \to M_2$ ein $K$-Isomorphismus. Dann existiert ein Isomorphismus $\tau: L_1 \to L_2$ der $\sigma$ fortsetzt.
...
Sei $K$ ein Körper und $f \in K[x]$ nicht konstant. \begin{itemize}
	...
	\item $f$ heißt separierbar, wenn $f$ in jeder Körpererweiterung von $K$ square-free ist. 
\end{itemize}
\textbf{Definition}\\
