...
\textbf{Satz}\\
Sei $R$ ein Faktorring und $f \in R[x]$. Sei $\pi \in R$ prim. Dann ist $f$ irreduzibel in $K[x]$ genau dann, wenn die Reduktion $\overline{f}$ modulo $\pi$ irreduzibel in $K[x]$ ist.\\
\textbf{Satz}\\
